	...
	while($row2 = mysqli_fetch_array($lrow, MYSQLI_BOTH))
{
	...
	<?php
	$facultyname1 = mysqli_query($con,"select name from faculty where faculty_id='".$row2[1]."'");
	?>
	<td><?php 
	while($facultyname = mysqli_fetch_array($facultyname1, MYSQLI_BOTH))
	echo "$facultyname[0]"?></td>
